...
- 1-smart-autocomplete: Added C# / .NET Framework 4.8 + ScriptDOM (T-SQL parsing), SMO (metadata), VS SDK 17.x, Community.VisualStudio.Toolkit

- 1-smart-autocomplete: Added C# 7.3 / .NET Framework 4.8 + Microsoft.SqlServer.TransactSql.ScriptDom, Microsoft.SqlServer.Management.Smo, Microsoft.VisualStudio.Shell.15.0, Community.VisualStudio.Toolkit

...
- C# on .NET Framework 4.8 + xUnit 2.6.*, Moq 4.20.*, Microsoft.NET.Test.Sdk 17.*, ScriptDOM, SMO wrappers (003-add-unit-tests)
- In-memory fixtures and test doubles (no external storage) (003-add-unit-tests)
...
## Recent Changes
- 003-add-unit-tests: Added C# on .NET Framework 4.8 + xUnit 2.6.*, Moq 4.20.*, Microsoft.NET.Test.Sdk 17.*, ScriptDOM, SMO wrappers
